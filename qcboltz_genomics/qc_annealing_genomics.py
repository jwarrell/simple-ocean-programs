...
for cMod in range(3):
    for cTrial in range(5):
      ...
      if cMod==0:
        fname = "/workspace/simple-ocean-programs/qcboltz_genomics/params/params_qboltz_" + str(cTrial+1) + ".csv"
      if cMod==1:
        fname = "/workspace/simple-ocean-programs/qcboltz_genomics/params/params_hqboltz_" + str(cTrial+1) + ".csv"
      if cMod==2:
        fname = "/workspace/simple-ocean-programs/qcboltz_genomics/params/params_hqboltz_aux_" + str(cTrial+1) + ".csv"
